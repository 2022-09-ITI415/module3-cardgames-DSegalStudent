...

{
    ...
    //the score properly also sets the scoreString
    public int score
    {
        get
        {
    ...
    private void Awake()
    {
        if (S == null)
        {
            S = this; // set the prvate singleton
        }
        else
        {
    ...
    //This will instantial a new Floating score GameObject and initialize it
    //It also returns a pointer to the Floating Score craeted so that the
    //Calling function can do more with it (Set font sizes ...)
